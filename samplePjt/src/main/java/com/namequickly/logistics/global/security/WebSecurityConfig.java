...
import com.namequickly.logistics.global.exception.ExceptionHandlerFilter;
import com.namequickly.logistics.global.jwt.JwtAuthFilter;
import com.namequickly.logistics.global.jwt.JwtUtil;
import com.namequickly.logistics.global.redis.RedisUtil;
    ...
    private void settingRequestAuthorization(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authz ->
            authz
                ...
                // 그 외
                .anyRequest().permitAll() //개발완료후 authenticated
        );
    }
}
